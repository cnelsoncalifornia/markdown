...
class C(BaseConstants):
    NAME_IN_URL = 'markdown_10_period3'
...
class Intro(Page):
    def vars_for_template(player: Player):
        if (player.subsession.session.config['first_session'] == 0) and (player.round_number == 1): # This app is the first.
...
class Bid1(Page):
    ...
    def vars_for_template(player: Player):
       ...
       return dict(
          image_path1= 'markdown_10_period3/markdown_{}_period3.jpg'.format(player.round_number),
          image_path2='markdown_10_period3/markdown_{}_graph.jpg'.format(player.round_number),
...
class CombinedResults(Page):
    ...
    def vars_for_template(player: Player):
        ...
        return dict(
            image_path= 'markdown_10_period3/markdown_{}_final.jpg'.format(player.round_number)
        )
