...
class C(BaseConstants):
    NAME_IN_URL = 'markdown_7_13_period3'
    PLAYERS_PER_GROUP = None
    NUM_ROUNDS = 2
    MAX = 20 # Maximum bid.
    NAMES = {
        1: ['Q', 'A'],  # First (highest) asset in market 1, second asset in market 2.
        2: ['L', 'E'],
    }
...
class Intro(Page):
    def vars_for_template(player: Player):
        if (player.subsession.session.config['first_session'] == 2) and (player.round_number == 1): # This app is the first.
...
class Bid1(Page):
    ...
    def vars_for_template(player: Player):
       ...
       return dict(
          image_path1= 'markdown_7_13_period3/markdown_{}_period3.jpg'.format(player.round_number),
          image_path2='markdown_7_13_period3/markdown_{}_graph.jpg'.format(player.round_number),
...
class CombinedResults(Page):
    ...
    def vars_for_template(player: Player):
        ...
        return dict(
            image_path= 'markdown_7_13_period3/markdown_{}_final.jpg'.format(player.round_number)
        )
